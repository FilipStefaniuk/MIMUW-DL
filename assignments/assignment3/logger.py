...
class Logger:
    def __init__(self, sess, config):
        ...
        self.summary_ops = {}
        self.summary_writer = tf.summary.FileWriter(self.config.summary_dir)
        self.best_score_writer = tf.summary.FileWriter(self.config.best_summary_dir)

    def summarize(self, step, summarizer="summary", summaries_dict=None):
        summary_writer = self.summary_writer if summarizer == "summary" else self.best_score_writer
