...
class RNNModel:
    ...
    def _build_model(self):
        ...
        with tf.name_scope("accuracy"):
            ...
            # tf.summary.scalar('acc_largest_num_open', self.acc[0])
            # tf.summary.scalar('acc_largest_num_consecutive', self.acc[1])
            # tf.summary.scalar('acc_largest_distance', self.acc[2])
